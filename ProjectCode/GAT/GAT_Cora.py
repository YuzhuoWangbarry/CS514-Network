...
class GAT_ten(torch.nn.Module):
    def __init__(self, dataset, hidden=8, heads=8):
        super(GAT_ten, self).__init__()
        ...
        self.conv5 = GATConv(heads * hidden, hidden, heads=heads)
        self.conv6 = GATConv(heads * hidden, hidden, heads=heads)
        self.conv7 = GATConv(heads * hidden, hidden, heads=heads)
        self.conv8 = GATConv(heads * hidden, hidden, heads=heads)
        self.conv9 = GATConv(heads * hidden, hidden, heads=heads)
        self.conv10 = GATConv(heads * hidden, dataset.num_classes, heads=heads, concat=False)
...
class GAT_two(torch.nn.Module):
    def __init__(self, dataset, hidden=8, heads=4):
        super(GAT_two, self).__init__()
        self.conv1 = GATConv(dataset.num_node_features, hidden, heads=heads)
        self.conv2 = GATConv(heads * hidden, dataset.num_classes, heads=heads, concat=False)
